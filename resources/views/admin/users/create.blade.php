<div class="modal-header border-0 pb-0">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h5 class="modal-title fw-bold mb-0">Utilizator nou</h5>
            <small class="text-muted">Completează datele pentru a crea un cont</small>
        </div>
    </div>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>

<form method="POST" action="{{ $link }}" class="dev-form">
    @csrf
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-light" name="name" value="{{ old('name') }}"
                        id="name" placeholder="Ion" required>
                </div>

                <div class="mb-3">
                    <label for="forename" class="form-label fw-semibold small">Nume</label>
                    <input type="text" class="form-control bg-light" name="forename" value="{{ old('forename') }}"
                        id="forename" placeholder="Popescu" required>
                </div>
                ...
                <div class="mb-0">
                    <label for="repassword" class="form-label fw-semibold small">Confirmă parola</label>
                    <div class="input-group">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control bg-light" name="email" value="{{ old('email') }}"
                        id="email" placeholder="ion@exemplu.com" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light" name="phone" value="{{ old('phone') }}"
                            id="phone" placeholder="7XX XXX XXX" required>
                    </div>
                </div>
                ...
                <div class="mb-0">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="activ" value="1" id="activSwitch"
                            {{ old('activ', 1) ? 'checked' : '' }}>
                        <label class="form-check-label small" for="activSwitch" id="activLabel">
                            <span
...
<script>
    ...
    document.getElementById('activSwitch')?.addEventListener('change', function() {
        const label = document.getElementById('activLabel');
        if (this.checked) {
            label.innerHTML =
